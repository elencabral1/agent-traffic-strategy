/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d7bc680a75aee63cb368c1ae6592023)
// Runtime types generated with workerd@1.20250410.0 2025-02-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		AGENT_TRAFFIC_STRATEGY: DurableObjectNamespace<import("./src/server").AgentTrafficStrategy>;
	}
}
